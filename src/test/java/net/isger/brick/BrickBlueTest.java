...
public class BrickBlueTest extends TestCase {
    ...
    public void testBlue() throws Exception {
        ...
        ms.coding("out", "println(obj)", "greeting"); // System.out.println(greeting);
        ...
        String e = ms.coding("new", "Example()");// Example e = new Example();
        ms.coding("out", "println(obj)", e); // System.out.println(e);
        ms.coding("out", "println(obj)", "class"); // System.out.println(Example.class);
